        ...
        <div>
            ...
            <section className="relative w-full aspect-[16/9]">
                ...
                <div className="absolute bottom-20 right-20 z-10 text-white text-left leading-relaxed space-y-5">
                    {/* 이름 및 소개 */}
                    <h2 className="text-4xl font-semibold tracking-widest">Rafel Moneo</h2>
                    ...
                    {/* 경력 및 수상 */}
                    <div className="flex justify-start gap-10 text-sm opacity-90 font-light">
                        {/* Reputations */}
                        <div>
                            ...
                            <ul className="space-y-1 leading-relaxed">
                                {[
                                    ...
                                    <li key={`${year}-${idx}`} className="flex gap-6">
